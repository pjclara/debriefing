...
class SurgeryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'perdas_estimadas'         => ['required', 'integer', 'min:0'],
            ...
            'co2_parametros'         => ['required', 'numeric', 'min:0'],
            'monopolar_coag_watts'   => ['required', 'integer', 'min:0'],
            'monopolar_coag_tipo'    => ['required', 'in:precise,flugurate,spray,low'],
            'monopolar_cut_watts'    => ['required', 'integer', 'min:0'],
            'monopolar_cut_tipo'     => ['required', 'in:pure,blend'],
            'bipolar_coag_watts'     => ['required', 'integer', 'min:0'],
            'bipolar_coag_tipo'      => ['required', 'in:low_with_autostop,low,standard,macro'],
            'b1'                     => ['required', 'array'],
            'b1.*'                   => ['integer'],
            'b2'                     => ['required', 'array'],
            'b2.*'                   => ['integer'],
            ...
            'b4'                     => ['required', 'array'],
            'b4.*'                   => ['integer'],
            'equipamento_extra'      => ['required', 'array'],
    ...
    public function messages(): array
    {
        return [
            ...
            'perdas_estimadas.required'        => 'Indique as perdas estimadas.',
            ...
            'co2_parametros.required'              => 'Indique os parâmetros de CO₂.',
            ...
            'monopolar_coag_watts.required'            => 'Indique a potência monopolar coag.',
            ...
            'monopolar_coag_tipo.required'             => 'Indique o tipo monopolar coag.',
            'monopolar_coag_tipo.in'                   => 'O tipo monopolar coag é inválido.',
            'monopolar_cut_watts.required'             => 'Indique a potência monopolar cut.',
            ...
            'monopolar_cut_tipo.required'              => 'Indique o tipo monopolar cut.',
